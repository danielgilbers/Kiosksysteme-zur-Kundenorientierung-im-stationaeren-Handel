...
L.Control.Search = L.Control.extend({
  onAdd: function () {
    this.container = L.DomUtil.create('div', 'rounded-start-5 rounded-end-5 px-3 py-2 searchBar')
    this.container.id = 'searchBar'
    this.container.innerHTML =
      '<div class="input-group d-flex" id="searchGroup">' +
      '<input id="searchBar" type="text" class="form-control border-0 p-0" placeholder="Was suchst du?" aria-label="Suchen" aria-describedby="addon-wrapping" autocomplete="off">' +
